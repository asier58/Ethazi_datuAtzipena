...
class Converter {
    ...
    public Boolean convertToXML(String inputFile, String outputFile)
    {
        ...
        try{
            ...
            //
            String archivo = ("C:/Users/Asier/git/repository/DatuAtzipenaethazi"+"/"+"enplegatua.csv");
    ...
    private void addRecordToRoot(String csvHeader, String outputFile){
        try {
            ...
            while((csvRecord = br.readLine()) != null){
            	kontador++;
                addElementsToRecord(csvRecord,kontador);
            }
     ...
     *
     */
    private void addElementsToRecord(String csvRecord, int kontador){
        ...
        record.setAttribute("id", String.valueOf(kontador));
